...
void ST7789_Test(void)
{
	...
	HAL_Delay(1000);
	ST7789_WriteString(10, 50, "Menu ", Font_16x26, WHITE, GREEN);
	HAL_Delay(2000);
	/*ST7789_WriteString(60, 75, "Jogo", Font_16x26, WHITE, GREEN);
	HAL_Delay(2000);
	...
	*/
	...
	ST7789_WriteString(10, 100, "Iniciar jogo", Font_16x26, WHITE, BLACK);
	ST7789_WriteString(10, 140, "Velocidade", Font_16x26, WHITE, BLACK);
	ST7789_WriteString(10, 180, "Escore", Font_16x26, WHITE, BLACK);
	HAL_Delay(3000);
